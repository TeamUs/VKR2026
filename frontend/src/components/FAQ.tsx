...
const FAQ: React.FC<FAQProps> = ({ onNavigate, toggleTheme, isDarkTheme }) => {
  ...
  const faqData = [
    ...
    // РЕФЕРАЛЬНАЯ ПРОГРАММА
    {
      ...
      answer: "Приглашайте друзей по реферальной ссылке. При первом заказе друга вы оба получите скидку 2% вместо 5% на 7 дней.",
      category: "Рефералы"
    },
    {
    ...
    },
    {
      ...
      answer: "За каждого приглашенного друга вы получаете скидку 2% на 7 дней. Чем больше друзей, тем больше экономия.",
      category: "Рефералы"
    },
    {
