...
const FAQ: React.FC<FAQProps> = ({ onNavigate, toggleTheme, isDarkTheme }) => {
  ...
  const faqData = [
    ...
    // РЕФЕРАЛЬНАЯ ПРОГРАММА
    {
      ...
      answer: "Приглашайте друзей по реферальной ссылке. При первом заказе друга вы оба получите скидку с 1000₽ до 400₽ на 7 дней.",
      category: "Рефералы"
    },
    {
    ...
    },
    {
      ...
      answer: "За каждого приглашенного друга вы получаете скидку с 1000₽ до 400₽ на комиссию на 7 дней. Чем больше друзей, тем больше экономия.",
      category: "Рефералы"
    },
    {
